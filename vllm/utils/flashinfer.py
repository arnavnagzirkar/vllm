...
"""Compatibility wrapper for FlashInfer API changes and MoE utilities.
...
__all__ = [
    ...
    # MoE weight utilities (consolidated from flashinfer_utils)
...
# ---------------------------------------------------------------------------
# MoE weight utilities
# (Previously in vllm.model_executor.layers.quantization.utils.flashinfer_utils)
# ---------------------------------------------------------------------------
...
def activation_to_flashinfer_int(activation) -> int:
    return activation_to_flashinfer_type(activation).value


def activation_to_flashinfer_type(activation) -> "ActivationType":
    from flashinfer.fused_moe.core import ActivationType
